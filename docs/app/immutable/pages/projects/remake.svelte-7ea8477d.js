import{S as ve,i as ye,s as be,k as g,w as ke,J as _e,d as a,m as v,x as Ee,g as T,y as Ie,q as $e,o as xe,B as Se,e as i,t as o,c as l,a as r,h as s,b as ie,K as e,E as je}from"../../chunks/index-227296ef.js";import{W as Re}from"../../chunks/WriteUp-6587def7.js";function qe(C){let h,d,u,t,m,y,O,w,P,E,A,N,I,G,U,W,c,z,$,J,F,x,H,B,b,K,M,S,Q,V,Y,j,L,X,R,Z,ee,te,oe,q,se,ae,D,ne;return{c(){h=i("h1"),d=o("The Remake"),u=g(),t=i("section"),m=i("p"),y=o("Dec 2021"),O=g(),w=i("p"),P=o(`Nowhere can anyone find better examples of how far they've come than by looking back at their
			own projects. Some of my oldies used `),E=i("code"),A=o("global scripts"),N=o(`
			within the `),I=i("code"),G=o("index.html"),U=o(`. Web dev has come a long way. The idea of mobile first and
			...
			looked into the `),$=i("code"),J=o("Reveal.js"),F=o(` project all I could see was some clever css styling for
			2013. Good in it's own time but not as good as `),x=i("code"),H=o("tailwindcss"),B=o(` today. For the
			interested reader, I suggest watching tailwind's
			`),b=i("a"),K=o("youtube videos"),M=o(`. The
			kicker for me was that implementing the same features as `),S=i("code"),Q=o("Reveal.js"),V=o(` is simpler with
			tailwind.`),Y=g(),j=i("p"),L=o(`Svelte's also very deserving of the lime light. Snappy navigation within the website is the
			...
			own projects. Some of my oldies used `),E=l(_,"CODE",{});var re=r(E);A=s(re,"global scripts"),re.forEach(a),N=s(_,`
			within the `),I=l(_,"CODE",{});var he=r(I);G=s(he,"index.html"),he.forEach(a),U=s(_,`. Web dev has come a long way. The idea of mobile first and
			responsive image sizing would've been huge development efforts not too long ago. Now I'm
			...
			project which in turn takes more time. It's usually easier to start from stratch and when I
			looked into the `),$=l(p,"CODE",{});var ce=r($);J=s(ce,"Reveal.js"),ce.forEach(a),F=s(p,` project all I could see was some clever css styling for
			2013. Good in it's own time but not as good as `),x=l(p,"CODE",{});var de=r(x);H=s(de,"tailwindcss"),de.forEach(a),B=s(p,` today. For the
			interested reader, I suggest watching tailwind's
			`),b=l(p,"A",{href:!0});var me=r(b);K=s(me,"youtube videos"),me.forEach(a),M=s(p,`. The
			kicker for me was that implementing the same features as `),S=l(p,"CODE",{});var fe=r(S);Q=s(fe,"Reveal.js"),fe.forEach(a),V=s(p,` is simpler with
			tailwind.`),p.forEach(a),Y=v(n),j=l(n,"P",{});var pe=r(j);L=s(pe,`Svelte's also very deserving of the lime light. Snappy navigation within the website is the
			default. Anyone on the internet these days has moved on from a website because it took too
			long to load or do something. Svelte.kit is the result of years of high requirements as well
			as a persmise of solving common issues that plague the well known frameworks. It was a no
