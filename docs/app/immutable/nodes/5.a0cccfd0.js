import{s as h,n as s}from"../chunks/scheduler.eb511182.js";import{S as p,i as d,s as c,g as m,x as u,f as n,c as g,h as y,z as b,k as w,a as r}from"../chunks/index.5942d4f5.js";function f(l){let o,e,i=`<p>Feb 2020</p> <p>Before going into details about what I’ve been working on for the last month or so, I’m going to
		...
		games, you name it, 9/10 times C or C++ was behind it. Javascript was a joke.</p> <p>But javascript had the internet. Fast forward to today and javascript is top of the
		...
		history of javascript enough justice. If you’ve got the time have a look into this video:</p> <iframe title="A fireship.io youtube video talking about the history of javascript" src="https://www.youtube.com/embed/Sh6lK57Cuk4" class="py-4 aspect-video"></iframe> <p>So where is C and C++ in all of this? Well, still back in system land. People were not about to
		jump up and down to rewrite all of their code in javascript. That would be silly. Instead, those
		languages saw their target - Webassembly. To the old and new, welcome to today&#39;s web.</p> <p>Right so what am I working on? Threejs is one of the biggest and best javascript libraries for
		...
		and want to adjust things to suit their needs, their options are rather limited.</p> <p>I’m one of those people. I wanted to add something in. Instead of throwing my hands up in the
		...
		realizing part A. Here’s to being a young developer everybody. Progress is hard.</p>`;return{c(){o=c(),e=m("section"),e.innerHTML=i,this.h()},l(t){u("svelte-v8wpkx",document.head).forEach(n),o=g(t),e=y(t,"SECTION",{class:!0,"data-svelte-h":!0}),b(e)!=="svelte-a9o3e4"&&(e.innerHTML=i),this.h()},h(){document.title="Three.js, Regular Expressions and Me",w(e,"class","flex flex-col")},m(t,a){r(t,o,a),r(t,e,a)},p:s,i:s,o:s,d(t){t&&(n(o),n(e))}}}class k extends p{constructor(o){super(),d(this,o,null,f,h,{})}}export{k as component};
