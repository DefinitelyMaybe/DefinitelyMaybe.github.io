import{S as Q,i as X,s as Y,k as p,w as Z,G as tt,d as i,m as c,x as et,g as K,y as ot,q as at,o as st,B as nt,e as l,t as y,c as h,a as d,h as w,P as G,b as u,H as e}from"../../chunks/index-deee8842.js";import{t as rt}from"../../chunks/Header-5af432b1.js";import{W as it}from"../../chunks/WriteUp-a37e0515.js";import{t as J,a as lt}from"../../chunks/threejslogowhite-f8c556b8.js";import"../../chunks/index-fe587174.js";function ht(f){let t,a,n,s,r,b,P,v,W,x,j,E,$,k,A,B,m,R,C,I,N,S,_,F,q,T,z;return{c(){t=l("section"),a=l("img"),s=p(),r=l("p"),b=y("Feb 2020"),P=p(),v=l("p"),W=y(`Before going into details about what I\u2019ve been working on for the last month or so, I\u2019m going to
			...
			Webassembly gave compute power to web development like no other. Electron made it possible to
			deploy to all platforms using only javascript. Actually, hold on, I don\u2019t think I can do the
			history of javascript enough justice. If you\u2019ve got the time have a look into this video:`),V.forEach(i),B=c(o),m=h(o,"IFRAME",{title:!0,src:!0,class:!0}),d(m).forEach(i),C=c(o),I=h(o,"P",{});var H=d(I);N=w(H,`So where is C and C++ in all of this? Well, still back in system land. People were not about to
			jump up and down to rewrite all of their code in javascript. That would be silly. Instead, those
			languages saw their target - Webassembly. To the old and new, welcome to today's web.`),H.forEach(i),S=c(o),_=h(o,"P",{});var U=d(_);F=w(U,`Right so what am I working on? Threejs is one of the biggest and best javascript libraries for
			those who want to work with graphics. If you want to create something 3D, threejs is where it's
			at. The library started purely in javascript but over recent years has adopted type support for
			typescript. As far as development is concerned, types are a boon like no other. \u201CWhat was the
			name of that function I made in this other module?\u201D, \u201CWhere did all of these errors come from?\u201D,
			...
			don\u2019t know whether this can be done. If there\u2019s some section of the code that assumes x, y, z
			and my parser breaks that, it\u2019s done for. Part B is that I may send weeks on this project before
			realizing part A. Here\u2019s to being a young developer everybody. Progress is hard.`),D.forEach(i),o.forEach(i),this.h()},h(){G(a.src,n=f[0])||u(a,"src",n),u(a,"alt","three.js logo"),u(a,"class","rounded-md"),u(m,"title","A fireship.io youtube video talking about the history of javascript"),G(m.src,R="https://www.youtube.com/embed/Sh6lK57Cuk4")||u(m,"src",R),u(m,"class","py-4"),u(t,"class","py-2 md:columns-2 lg:columns-3")},m(g,o){K(g,t,o),e(t,a),e(t,s),e(t,r),e(r,b),e(t,P),e(t,v),e(v,W),e(t,x),e(t,j),e(j,E),e(t,$),e(t,k),e(k,A),e(t,B),e(t,m),e(t,C),e(t,I),e(I,N),e(t,S),e(t,_),e(_,F),e(t,q),e(t,T),e(T,z)},p(g,o){o&1&&!G(a.src,n=g[0])&&u(a,"src",n)},d(g){g&&i(t)}}}function dt(f){let t,a,n;return a=new it({props:{$$slots:{default:[ht]},$$scope:{ctx:f}}}),{c(){t=p(),Z(a.$$.fragment),this.h()},l(s){tt('[data-svelte="svelte-2omp41"]',document.head).forEach(i),t=c(s),et(a.$$.fragment,s),this.h()},h(){document.title="Three.js, Regular Expressions and me"},m(s,r){K(s,t,r),ot(a,s,r),n=!0},p(s,[r]){const b={};r&3&&(b.$$scope={dirty:r,ctx:s}),a.$set(b)},i(s){n||(at(a.$$.fragment,s),n=!0)},o(s){st(a.$$.fragment,s),n=!1},d(s){s&&i(t),nt(a,s)}}}function pt(f,t,a){let n=J;return rt.subscribe(s=>{s==="light"?a(0,n=J):a(0,n=lt)}),[n]}class wt extends Q{constructor(t){super(),X(this,t,pt,dt,Y,{})}}export{wt as default};
